...
for(let i=0; i<supplyChanges.length; i++) {
  let supplyItem = supplyChanges[i];

  if(supplyItem > 0){
    positives.push(supplyItem);
  } else if (supplyItem < 0){
    negatives.push(supplyItem);
  }else if (supplyItem === 0){
    zeroes.push(supplyItem);
  }
}
console.log('These are the positives:', positives);
console.log('These are the negatives:', negatives);
console.log('These are the zeroes:', zeroes);
...
for(supplyItem of supplyChanges) {
 
  if(supplyItem > 0){
    stretchPositives.push(supplyItem);
  } else if (supplyItem < 0){
    stretchNegatives.push(supplyItem);
  }else if (supplyItem === 0){
    stretchZeroes.push(supplyItem);
  }
}
console.log('These are the positives:', positives);
console.log('These are the negatives:', negatives);
...
for( let supplyItem of supplyChanges ){
  totalParts = supplyItem + totalParts;
}

console.log('Hey! These are the total parts:', totalParts);
...
console.log('Here are the boxes filled:', boxesFilled, 'Here are the leftover parts:', parts);
